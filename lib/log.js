...
/**
 * Netlify prints their own timestamps, let's just use console.log directly.
 * Otherwise use `fancyLog`, with timestamps.
 */
const doLog = argv.netlify ? console.log : fancyLog;

export function error(...args) {
  doLog(red('Error:'), ...args);
}
